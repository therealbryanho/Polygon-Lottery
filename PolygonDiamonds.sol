...
contract PolygonDiamonds is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;
 
  Counters.Counter private supply;
 
  string public uriPrefix = "ipfs://QmcdEyrr7N8FhcpX4UVBepAcUHCC16nyKnJWykvcv1dqto/";
  string public prizeA = "blue";
  string public prizeB = "yellow";
  string public prizeC = "red";
  string public prizeD = "dark-purple";
  string public prizeE = "light-purple";
  ...
  constructor() ERC721("Polygon Diamonds", "DIA") {
  }
